...
| <a name="input_onboarding_dedicated_project_name"></a> [onboarding\_dedicated\_project\_name](#input\_onboarding\_dedicated\_project\_name) | Google Cloud Dedicated Project Name (This should be provided only if var.dedicated\_project is 'true') | `string` | `null` | no |
| <a name="input_onboarding_firewall_name"></a> [onboarding\_firewall\_name](#input\_onboarding\_firewall\_name) | Firewall name created in the root module. | `string` | n/a | yes |
